...
{if $errors|@count == 0}
            ...
            {if !$content_only}
                <div class="container">
                    ...
                    {if $product->reference== $product->ean13}
                        <h1 class="name-header-main" style="padding-bottom:4px;" itemprop="name">{$product->name|escape:'html':'UTF-8'}

                            {if !isset($groups)},{$product->reference|escape:'html':'UTF-8'}{/if}
                        </h1>
                    {else}
                        <h1 class="name-header-main" style="padding-bottom:4px;" itemprop="name">{$product->name|escape:'html':'UTF-8'}{if !empty($product->reference) && $product->reference}, {$product->reference|escape:'html':'UTF-8'}{/if}{if !empty($product->ean13) && $product->ean13}, {$product->ean13|escape:'html':'UTF-8'}{/if}</h1>
            {/if}
    ...
    {if empty($product->reference) || !$product->reference}{/if},
    {if !isset($groups)}{$product->reference|escape:'html':'UTF-8'}{/if}{if !empty($product->ean13) && $product->ean13},{$product->ean13}{/if}
    </p>
    ...
    <div class="pb-center-column col-xs-12 col-sm-5">
        {include file="$tpl_dir./blockmap.tpl"}
    </div>
    <!-- end center infos-->
    <!-- pb-right-column-->
    <div class="pb-right-column col-xs-12 col-sm-3 col-md-4">
...
{if !$content_only}
        ...
        <section class="page-product-box">
            ...
            <table class="table-data-sheet">
                {foreach from=$features item=feature}
                    {if $feature.name !='State' || ($product->reference !=$product->ean13)}
    ...
    {if isset($product) && $product->description}
        <!-- More info -->
        <section class="page-product-box">
            <h3 class="page-product-heading">{l s='About '}{$product->name|truncate:25:'...'|escape:'html':'UTF-8'}</h3>
            <!-- full description -->
