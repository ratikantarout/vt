...
<div id="login-panel">
    ...
    {*<div id="shop-img">
    <img src="{$img_dir}visit-logo-1458505776.jpg" alt="{$shop_name}" width="69.5px" height="118.5px" />
    </div>*}
            ...
            <div class="front panel">
                <h4 id="shop_name">
                    <h1 class="text-center">
                        <img id="logo" src="{$img_dir}visit-logo-1458505776.jpg" width="123px" height="24px" alt="PrestaShop" />
                    </h1>
    ...
    <div id="login-footer">
        <p class="text-center text-muted">
            <a href="http://www.visitortrip.com/" onclick="return !window.open(this.href);">
                &copy; VisitorTrip&#8482; {$smarty.now|date_format:"%Y"} - All rights reserved
            </a>
        </p>
        <p class="text-center">
