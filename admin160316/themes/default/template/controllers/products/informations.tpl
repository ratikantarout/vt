...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="reference">
			...
			title="{l s='Your District or Location Name'} {l s='Allowed special characters:'} .-_#\ ">
				{$bullet_common_field} {l s='Dist/Location'}
			</span>
		</label>
		<div class="col-lg-5">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="ean13">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s='This place is in which state ?'}">
				{$bullet_common_field} {l s='State'}
			</span>
		</label>
		<div class="col-lg-3">
			<input maxlength="64" type="text" id="ean13" name="ean13" value="{$product->ean13|htmlentitiesUTF8}" />
		</div>
	</div>
